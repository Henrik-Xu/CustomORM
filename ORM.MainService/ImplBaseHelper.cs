...
{
    public class ImplBaseHelper<TConnection, TCommand, TReader, TParam> : IBaseDALHelper<TReader, TParam>
...

    {
        ...
        public object GetSingleResult(string cmdText, TParam[] param = null, bool isStoreProcesure = false)
        {
            TConnection conn = new TConnection();
            conn.ConnectionString = connString;
            TCommand cmd = new TCommand();
